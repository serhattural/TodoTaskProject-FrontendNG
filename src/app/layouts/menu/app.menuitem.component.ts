...
@Component({
    ...
    template: `
        <ng-container>
            ...
            <a [appAuthRole]="item.roles" [attr.href]="item.url" (click)="itemClick($event)" *ngIf="!item.routerLink || item.items" (keydown.enter)="itemClick($event)"
...
export class AppMenuitemComponent implements OnInit, OnDestroy {
    ...
    constructor(public app: MainLayoutComponent, public router: Router, private cd: ChangeDetectorRef, private menuService: MenuService) {
